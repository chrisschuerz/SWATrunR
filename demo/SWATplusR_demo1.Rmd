...
run_swat_parallel <- function(param) {
  run_swat2012(project_path = "C:/sb14_full",
...
par_names <- c("cnop_till::CNOP_TILL.mgt|change = rel", "awc::SOL_AWC.sol|change = rel", "esco::ESCO.hru|change = rep", "ge_del::GW_DELAY.gw|change = rep", "sft::SFTMP.bsn|change = rep")
