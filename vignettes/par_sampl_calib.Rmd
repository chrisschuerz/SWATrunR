...
```{r, echo=F}
demo_path <- "C:/Users/schuerz/Documents/swatplus/swatplus_rev60_demo"
```
...
```{r, eval=FALSE}
et_yld <- run_swatplus(project_path = demo_path,
...
```{r, eval=F}
et_yld2 <- run_swatplus(project_path = demo_path,
                        output = list(et      = define_output(file = 'basin_wb', 
                                                              variable = 'et', 
                                                              unit = 1),
                                      yld_ag1 = define_output(file = 'hru_pw',
...
```{r, eval=FALSE}
qsim_cal <- run_swatplus(project_path = demo_path,
...
qsim_val <- run_swatplus(project_path = demo_path,
                         output = list(q = define_output(file = 'channel_sd', 
                                                         variable = 'flo_out', 
                                                         unit = 1)),
                         parameter = par_val,
